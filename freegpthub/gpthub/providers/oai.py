...
CHATGPT_ANYWHERE_FREE_API_KEYS = {
    'gpt-5.2': CHATGPT_ANYWHERE_SHARED_KEYS, 'gpt-5.1': CHATGPT_ANYWHERE_SHARED_KEYS, 'gpt-5': CHATGPT_ANYWHERE_SHARED_KEYS,
    'gpt-4o': CHATGPT_ANYWHERE_SHARED_KEYS, 'gpt-4.1': CHATGPT_ANYWHERE_SHARED_KEYS, 'gpt-4o-mini': CHATGPT_ANYWHERE_SHARED_KEYS,
    'gpt-3.5-turbo': CHATGPT_ANYWHERE_SHARED_KEYS, 'gpt-4.1-mini': CHATGPT_ANYWHERE_SHARED_KEYS, 'gpt-4.1-nano': CHATGPT_ANYWHERE_SHARED_KEYS,
    'gpt-5-mini': CHATGPT_ANYWHERE_SHARED_KEYS, 'gpt-5-nano': CHATGPT_ANYWHERE_SHARED_KEYS,
}
...
class OpenAIChatGPTEndpoints(BaseEndpoint):
    ...
    def __init__(self, **kwargs):
        ...
        for ver in list(CHATGPT_ANYWHERE_FREE_API_KEYS.keys()):
        ...
        for ver in list(CHATGPT_BIANXIE_FREE_API_KEYS.keys()):
    ...
    def chatanywhereapiv1(self, req: ChatRequest, request_overrides: dict = None, version: str = None) -> ChatResponse:
        return self.openaisdk(
            base_url='https://api.chatanywhere.tech/v1', candidate_api_keys=CHATGPT_ANYWHERE_FREE_API_KEYS, api_family='client.chat.completions.create',
