...
from freegpthub import ZhipuGLMEndpoints, ChatRequest
...
class FreeGPTHubLLM:
    ...
    def complete(self, prompt: str, system: str | None = None, temperature: float = 0.6, max_tokens: int = 2048, **kwargs: Any) -> str:
        ...
        openai_cfg: Dict[str, Any] = {"messages": messages, "temperature": temperature, "max_tokens": max_tokens}
